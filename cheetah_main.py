...
sys.path.append(os.path.join(os.path.dirname(__file__), 'cheetah/binding/python'))

from cheetah import Cheetah
from cheetahparser import *
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=abs_path('cheetah/lib/linux/x86_64/libpv_cheetah.so'))

    parser.add_argument(
        '--acoustic_model_path',
        help='absolute path to acoustic model parameter file',
        default=abs_path('cheetah/lib/common/acoustic_model.pv'))

    parser.add_argument(
        '--language_model_path',
        help='absolute path to language model parameter file',
        default=abs_path('cheetah/lib/common/language_model.pv'))
    ...
    CheetahRealtimeDemo(
        ...
        license_path="cheetah/license_cta_v1.2.0_linux_expires_1_11_2021.lic").run()
